...
{
       0,    28,    28,    32,    36,    39,    44,    48,    53,    56,
      62,    65,    68,    75,    79,    82,    85,    89,    92,    98,
     104,   109,   114,   117,   121,   127,   131,   134,   138,   141,
     146,   153,   162,   169,   173,   176,   181,   184,   189,   192,
     198,   203,   208,   213,   218,   223,   228,   233,   238,   243,
     247,   251,   257,   262,   268,   273,   276,   279,   282,   287
};
#endif
...
#line 28 "syntax.y" /* yacc.c:1646  */
    {
		...
		/*if(!flexerror&&!bisonerror)print($$);*/Program((yyval.sign));}
