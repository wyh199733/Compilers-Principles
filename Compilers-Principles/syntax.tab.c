...
{
       0,    30,    30,    33,    37,    40,    45,    49,    54,    57,
      63,    66,    69,    76,    80,    83,    86,    90,    93,    99,
     105,   110,   115,   118,   122,   128,   132,   135,   139,   142,
     147,   154,   163,   170,   174,   177,   182,   185,   190,   193,
     199,   204,   209,   214,   219,   224,   229,   234,   239,   244,
     248,   252,   258,   263,   269,   274,   277,   280,   283,   288
};
#endif
...
#line 30 "syntax.y" /* yacc.c:1646  */
    {
		...
		links((yyval.sign),(yyvsp[0].sign));print((yyval.sign));}
...
#line 37 "syntax.y" /* yacc.c:1646  */
    {
		(yyval.sign)=create_sign("ExtDefList(ε)",yylineno);
		(yyval.sign)->token=0;}
...
#line 83 "syntax.y" /* yacc.c:1646  */
    {
		(yyval.sign)=create_sign("OptTag(ε)",yylineno);
		(yyval.sign)->token=0;}
...
#line 132 "syntax.y" /* yacc.c:1646  */
    {
		(yyval.sign)=create_sign("StmtList(ε)",yylineno);
		(yyval.sign)->token=0;}
...
#line 174 "syntax.y" /* yacc.c:1646  */
    {
		(yyval.sign)=create_sign("DefList(ε)",yylineno);
		(yyval.sign)->token=0;}
...
int print(struct sign *root)
{
	...
	if(!error&&!flexerror){
	printf("%s (%d)\n",root->type,root->line);
	struct sign* now=root->leaf,sign ;
	while(now!=root){
	for(i=0;i<j;i++){
	printf("  ");
	}
